...
public class YoloUI {
    ...
    private File selectedFile = new File("AutonomousDriving/src/main/resources/videoSample2.mp4");
    private VideoPlayer videoPlayer;
    private jar progressBar;
    ...
    public void initUI() throws Exception {
        ...
        yoloChooser();
        JComboBox<Speed> choose = speedChooser();
    ...
    private void addSignature() {
        JLabel signature = new JLabel("Project by Bhanu and Avilash", SwingConstants.CENTER);
